    ...
    <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="card p-6 text-center hover:shadow-lg transition-shadow">
            <Image
              ...
              loading="lazy"
            />
            <h3 className="text-xl font-bold text-primary">InspireXcellence</h3>
            <p className="text-grayText mt-2">
              Inspiring individuals to achieve personal growth, health, wealth,
              and happiness.
            </p>
            <div className="mt-4">
              <a
          ...
          <div className="card p-6 text-center hover:shadow-lg">
            ...
            <p className="text-grayText mt-2">A shop for developer clothes!</p>
            <div className="mt-4">
              <a
      ...
      <section className="section text-center">
        <p className="text-lg max-w-2xl mx-auto text-grayText">
          I’m a perpetual creator, dedicated to shaping fresh ideas that leave a
          sketch on the world.
        </p>
      </section>
    </div>
