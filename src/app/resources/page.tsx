...
export const metadata: Metadata = {
  title: staticPages.resources.metaTitle,
  description: staticPages.resources.metaDescription,
  openGraph: {
    ...staticPages.resources.openGraph,
    url: "https://rajondey.com/resources",
  },
  twitter: staticPages.resources.twitter,
};
        ...
        <section className="section">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <Link href="/resources/videos" className="card p-6 text-center">
              ...
              <p className="text-grayText mt-2">
                Watch vlogs, creative projects, and personal stories on my
                YouTube channel.
              </p>
            </Link>
